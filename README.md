...
<br />
The pipeline aims to identify common marmosets (*Callithrix jacchus*) in the laboratory captivity. We construct the pipeline based on the You Only Look Once (YOLO) algorithms, version 8 (Jocher et al., 2023).
